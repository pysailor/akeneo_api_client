...
# -*- coding: utf-8 -*-
#
# Akeneo PIM Python API Client documentation build configuration file, created by
# sphinx-quickstart on Fri Oct 27 12:08:43 2017.
#
...
htmlhelp_basename = "AkeneoPIMPythonAPIClientdoc"
...
latex_documents = [
    (
        master_doc,
        "AkeneoPIMPythonAPIClient.tex",
        "Akeneo PIM Python API Client Documentation",
        "matthieudelaro",
        "manual",
    ),
]
